function init() {
	...
	_default.id = 'egypt';
	_default.title = 'Egypt';
	_default.title_local = 'Egyptian';
	...
	//OVERALL POPULATION
	_default.total_population = 89580000;
	...
	_default.percentage_of_population_with_diabetes = 15.42;
	...
	_default.duration_of_diabetes_t1dm_5 = 12.50;
	_default.duration_of_diabetes_t1dm_5_10 = 20.00;
	_default.duration_of_diabetes_t1dm_10 = 67.50;
	//_default.duration_of_diabetes_t1dm_all = 100.00;
	
	_default.duration_of_diabetes_t2dm_5 = 7.50;
	_default.duration_of_diabetes_t2dm_5_10 = 10.00;
	_default.duration_of_diabetes_t2dm_10 = 82.50;
	//_default.duration_of_diabetes_t2dm_all = 100.00;		
				
	//T1DM POPULATION
	_default.t1dm_percentage_of_patients_treated_with_basal_long_acting_insulin_glargine = 98.00;
	...
	//WORLD WITH BASAGLAR
	_default.t1dm_lantus_market_share_split = 75.00;
	...
	//T2DM POPULATION
	_default.t2dm_percentage_of_patients_treated_with_basal_long_acting_insulin_glargine = 48.00;	
	...
	//WORLD WITHOUT BASAGLAR
	_default.t2dm_percentage_of_basal_insulin_market_who_are_new_initiators = 32.00;
	...
	//WORLD WITH BASAGLAR
	_default.t2dm_lantus_market_share_split = 55.00;
	...
	//LANTUS PENS
	_default.price_lantus_wholesaler_pens = 367.00;
	_default.price_lantus_public_pens = 450.00;
	_default.price_lantus_manufacturer_pens = 317.00;
	//LANTUS CARTRIDGES
	_default.price_lantus_wholesaler_cartridges = 325.00;
	_default.price_lantus_public_cartridges = 399.00;
	_default.price_lantus_manufacturer_cartridges = 281.00;
	...
	//BASAGLAR PENS
	_default.price_basaglar_wholesaler_pens = 47.00;
	_default.price_basaglar_public_pens = 57.47;
	_default.price_basaglar_manufacturer_pens = 47.00;
	//BASAGLAR CARTRIDGES
	_default.price_basaglar_wholesaler_cartridges = 41.00;
	_default.price_basaglar_public_cartridges = 55.55;
	...
	_default.price_lantus_pack_price = 450.00;
