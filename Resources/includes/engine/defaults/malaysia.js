function init() {
	...
	_default.id = 'malaysia';
	_default.title = 'Malaysia';
	_default.title_local = 'Malaysian';
	...
	_default.duration_of_diabetes_t1dm_5 = 52.50;
	_default.duration_of_diabetes_t1dm_5_10 = 23.75;
	_default.duration_of_diabetes_t1dm_10 = 23.75;
	//_default.duration_of_diabetes_t1dm_all = 100.00;
	
	_default.duration_of_diabetes_t2dm_5 = 26.00;
	_default.duration_of_diabetes_t2dm_5_10 = 40.00;
	_default.duration_of_diabetes_t2dm_10 = 34.00;
	//_default.duration_of_diabetes_t2dm_all = 100.00;		
				
	//T1DM POPULATION
	_default.t1dm_percentage_of_patients_treated_with_basal_long_acting_insulin_glargine = 63.00;
	...
	_default.t1dm_percentage_of_basal_insulin_market_who_are_new_initiators = 15.00;
	...
	//T2DM POPULATION
	_default.t2dm_percentage_of_patients_treated_with_basal_long_acting_insulin_glargine = 19.00;	
	...
	//WORLD WITHOUT BASAGLAR
	_default.t2dm_percentage_of_basal_insulin_market_who_are_new_initiators = 18.00  ;
	...
	//LANTUS PENS
	_default.price_lantus_wholesaler_pens = 204.00;
	_default.price_lantus_public_pens = 271.00;
	_default.price_lantus_manufacturer_pens = 177.00;
	//LANTUS CARTRIDGES
	_default.price_lantus_wholesaler_cartridges = 242.00;
	_default.price_lantus_public_cartridges = 322.00;
	_default.price_lantus_manufacturer_cartridges = 210.00;
	...
	//BASAGLAR PENS
	_default.price_basaglar_wholesaler_pens = 49.00;
	_default.price_basaglar_public_pens = 51.00;
	_default.price_basaglar_manufacturer_pens = 49.00;
	//BASAGLAR CARTRIDGES
	_default.price_basaglar_wholesaler_cartridges = 49.00;
	_default.price_basaglar_public_cartridges = 51.00;
	_default.price_basaglar_manufacturer_cartridges = 49.00;
	...
	_default.price_lantus_pack_price = 271.00;
